...
<What was the situation? What constraints (technical, time, ecosystem) applied at the time?>
...
<What do we give up? What could go wrong?>

### Outcome / Lessons Learned

<What actually happened after this decision was implemented? Fill in once enough time has passed.>
```
